                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p class="text-md text-gray-500">Gestisci la ricezione delle email dalla piattaforma.</p>
                                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p class="text-md text-gray-500">Questa azione richiederà l'intervento di un amministratore per essere annullata.</p>
                                    </div>
