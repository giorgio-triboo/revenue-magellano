...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="userManagement()">
            ...
            <form action="{{ route('users.index') }}" method="GET" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center">
                        @if (request('search'))
                            <a href="{{ route('users.index') }}" class="pr-2">
                ...
                <div class="overflow-hidden shadow-md rounded-xl bg-custom-card">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <div class="flex justify-end space-x-2">
                                            @if ($user->trashed())
                                                <button @click="confirmRestore('{{ $user->id }}')"
                                                    class="text-green-600 hover:text-green-700" title="Ripristina utente">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 whitespace-nowrap text-md text-gray-500 text-center">
    ...
    <!-- User Details Modal -->
    <div x-show="showModal" class="fixed inset-0 z-50 overflow-y-auto" x-cloak aria-labelledby="user-details-modal"
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                        <div class="flex items-center justify-between">
                            <h3 id="user-details-modal" class="text-lg leading-6 font-medium text-gray-900"
